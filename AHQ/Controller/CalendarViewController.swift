...
class CalendarViewController: UIViewController, GIDSignInUIDelegate, GIDSignInDelegate {
    ...
    override func viewDidLoad() {
        ...
        output.frame = CGRect(x: 0, y: 100, width: view.frame.width, height: view.frame.height)
